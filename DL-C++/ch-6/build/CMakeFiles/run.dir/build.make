...
CMakeFiles/run: bin/mse_demo
	@$(CMAKE_COMMAND) -E cmake_echo_color "--switch=$(COLOR)" --blue --bold --progress-dir=/Users/arkajyotisaha/Desktop/DLusingC++/DL-C++/ch-6/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Running MSE cost function demo"
	echo ===\ Running\ Mean\ Squared\ Error\ Demo\ ===
	echo This\ demo\ generates\ synthetic\ data\ and\ compares\ two\ hypothesis\ functions
	echo Data:\ Y\ =\ 2*X\ +\ 3\ +\ noise
	echo H0:\ Y\ =\ -1*X\ +\ 4
	echo H1:\ Y\ =\ 1.5*X\ +\ 1
	bin/mse_demo
